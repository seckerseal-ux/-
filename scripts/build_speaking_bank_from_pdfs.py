        ...
        prompts.append(
            {
                ...
                "part": "part1",
                "title": title_cn,
                "intro": f"周思成题库补充 · {title_en}。Part 1 建议每题用 2-4 句回答，并顺手补一个原因或小例子。",
                "questions": questions,
            ...
            part2_prompts.append(
                {
                    ...
                    "part": "part2",
                    "title": title_cn,
                    "intro": f"周思成题库补充 · Describe {describe_title}。Cue Card 建议按提示词讲清背景、细节、感受和原因。",
            ...
            part3_prompts.append(
                {
                    ...
                    "intro": f"周思成题库补充 · 围绕“{title_cn}”做 Part 3 延伸，尽量给观点、原因和例子。",
