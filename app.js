...
const expandedVocabularyBank = [
  ...
  ...createExpandedVocabularyEntries("write", "writing", [
    ...
    },
    {
      id: "body-evidence",
      kind: "chunk",
      term: "a growing body of evidence suggests that",
    ...
    },
    {
      id: "far-reaching",
      kind: "chunk",
      term: "have far-reaching implications for",
    ...
    },
    {
      id: "attributed-to",
      kind: "chunk",
      term: "this can largely be attributed to",
    ...
    },
    {
      id: "viable-solution",
      kind: "chunk",
      term: "a viable solution would be to",
  ...
  ...createExpandedVocabularyEntries("speak", "speaking", [
    ...
    },
    {
      id: "comes-to-mind",
      kind: "chunk",
      term: "the first thing that comes to mind is",
    ...
    },
    {
      ...
      kind: "chunk",
      term: "speaking from personal experience",
    ...
    },
    {
      id: "worth-mentioning",
      kind: "chunk",
      term: "one thing worth mentioning is that",
    ...
    },
    {
      id: "depends-on",
      kind: "chunk",
      term: "I would say it depends on",
      translation: "我会说这要看……",
    ...
    },
    {
      id: "kind-of-person",
      kind: "chunk",
      term: "I am the kind of person who",
    ...
    },
    {
      id: "matters-most",
      kind: "chunk",
      term: "what matters most to me is",
